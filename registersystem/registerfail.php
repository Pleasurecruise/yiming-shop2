<?php
$url = "https://shop2.yiming1234.cn/index1.html";
$title = "Register fail";
?>
<html>
<head>
...
<body>
    <div class="loader">
        <div class="loader-inner pacman">
            ...
            <div></div>
            <div></div>
            <span class="loader-text">The registration password must contain at least one uppercase letter, one lowercase letter and one digit. Additionally, the password must be at least 8 characters long……</span>
        </div>
    </div>
	</body>
</html>
